...
#name: gnome-dash-fix
#author: Ben Godfrey
#description: Makes the GNOME Shell Apps Dashboard sort the apps into their respective categories based on the FreeDesktop standard.
#version: 1.0
#root: yes
#category: gnome
#distro: debianbased

# source: https://github.com/BenJetson/gnome-dash-fix/blob/master/appfixer.sh
